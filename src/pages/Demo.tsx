              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <Textarea id="message" value={formData.message} onChange={(e) => handleInputChange('message', e.target.value)} placeholder="Any specific questions or requirements..." rows={3} />
                  </div>
              ...
              <Card className="border-0 shadow-lg bg-blue-50">
                ...
                <CardContent className="space-y-3">
                  <div className="flex items-center">
                    <Clock className="h-5 w-5 text-blue-600 mr-3" /> <span>Duration: 45-60 minutes</span>
                  </div>
                  <div className="flex items-center">
                    <Users className="h-5 w-5 text-blue-600 mr-3" /> <span>One-on-one with expert instructor</span>
                  </div>
                  <div className="flex items-center">
                    <Award className="h-5 w-5 text-blue-600 mr-3" /> <span>Course roadmap & career guidance</span>
                  </div>
                  <div className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-blue-600 mr-3" /> <span>Free course materials</span>
                  </div>
                </CardContent>
              </Card>
              <Card className="border-0 shadow-lg bg-green-50">
                <CardContent className="pt-6">
                  <div className="text-center">
                    <h3 className="font-bold text-green-800 mb-2">🌟 Why Choose LinuxForge?</h3>
                    <p className="text-green-700 text-sm">
                      Get expert guidance, personalized career support, and hands-on learning with real-world projects — all designed to help you succeed.
                    </p>
                  </div>
                </CardContent>
              </Card>
